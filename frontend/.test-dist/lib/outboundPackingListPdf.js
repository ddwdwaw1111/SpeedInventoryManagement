...
const PACKING_LIST_TABLE_LAYOUT = {
...
export function downloadOutboundDeliveryNotePdfFromDocument(document) {
...
export function downloadOutboundPackingListPdfFromDocument(document) {
    downloadOutboundDeliveryNotePdfFromDocument(document);
}
export function buildDeliveryNoteDocumentFromDocument(document) {
    return {
...
export function buildDeliveryNoteDefinition(document) {
...
function toDeliveryNoteRowFromLine(line, document) {
    return {
        id: line.id,
