      ...
      <DialogContent dividers className="bulk-inbound-dialog__content">
        ...
        {step === "PREVIEW" && preview ? (
          <div className="bulk-inbound-preview">
            <div className="bulk-inbound-preview__banner"><div><span>{preview.sourceFileName}</span><strong>{preview.customerName} · {t("bulkOutboundWarehouseCount", { count: preview.locationCount })}</strong></div><p>{t("bulkOutboundPreviewHint")}</p></div>
