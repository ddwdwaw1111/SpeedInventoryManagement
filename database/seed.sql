...
VALUES
  ((SELECT id FROM sku_master WHERE sku = '023042'), (SELECT id FROM customers WHERE name = 'SpeedWin'), '023042', 'ALUMINIUM FOIL CONTAINER', 'Food Packaging', 'ALUMINIUM FOIL CONTAINER', 'pcs', 1958, 300, 1, 'TEMP', '2025-12-19', 'MRSU7765631', 1946, 1958, 87, NULL, CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = '033768'), (SELECT id FROM customers WHERE name = 'SpeedWin'), '033768', 'ALUMINIUM FOIL CONTAINER', 'Food Packaging', 'ALUMINIUM FOIL CONTAINER', 'pcs', 2751, 250, 1, 'TEMP', '2025-12-11', 'KKFU7963968', 2751, 2751, 87, NULL, CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = 'VB72GC'), (SELECT id FROM customers WHERE name = 'ODW'), 'VB72GC', '72 OZ ALUMINUM TAKE OUT CONTAINER COMBO', 'Food Packaging', '72 OZ ALUMINUM TAKE OUT CONTAINER COMBO', 'pcs', 564, 120, 2, 'TEMP', '2025-12-11', 'TLLU5105021', 564, 564, 87, NULL, CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = '023127'), (SELECT id FROM customers WHERE name = 'SpeedWin'), '023127', 'FOIL LID FOR ALUMINIUM KITCHEN WARE CONTAINER', 'Food Packaging', 'FOIL LID FOR ALUMINIUM KITCHEN WARE CONTAINER', 'pcs', 3330, 400, 2, 'TEMP', '2025-12-19', 'MRSU8580370', 3330, 3330, 87, NULL, CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = '023134'), (SELECT id FROM customers WHERE name = 'ODW'), '023134', 'ALUMINIUM KITCHEN WARE CONTAINER', 'Food Packaging', 'ALUMINIUM KITCHEN WARE CONTAINER', 'pcs', 1430, 180, 3, 'TEMP', '2025-12-08', 'HASU4467200', 1430, 1430, 87, NULL, CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = '033782'), (SELECT id FROM customers WHERE name = 'ODW'), '033782', 'ALUMINIUM KITCHEN WARE CONTAINER', 'Food Packaging', 'ALUMINIUM KITCHEN WARE CONTAINER', 'pcs', 1430, 180, 3, 'TEMP', '2025-12-08', 'MRKU3310106', 1431, 1430, 87, '2025-12-18', CURRENT_TIMESTAMP),
  ((SELECT id FROM sku_master WHERE sku = '023141'), (SELECT id FROM customers WHERE name = 'ODW'), '023141', 'ALUMINIUM KITCHEN WARE CONTAINER', 'Food Packaging', 'ALUMINIUM KITCHEN WARE CONTAINER', 'pcs', 1399, 150, 3, 'TEMP', '2025-12-08', 'TRHU7293759', 1399, 1399, 87, NULL, CURRENT_TIMESTAMP)
ON DUPLICATE KEY UPDATE
