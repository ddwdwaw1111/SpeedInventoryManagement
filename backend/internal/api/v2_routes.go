...
func (s *Server) registerV2Routes(protected gin.IRouter) {
	...
	operator.POST("/pallet-operations/move", s.handleV2MovePallets)
	operator.POST("/pallet-operations/adjust", s.handleV2AdjustPallets)
	operator.POST("/pallet-operations/rework", s.handleV2ReworkPallets)
